var endpoint = window.location.hostname == "127.0.0.1" ? "10.0.77.180" : window.location.hostname;
...
sentences.push({ text: "Unit [NECHRY-3722-1628]\n", speed: 1 });
...
connection.onmessage = (e) => {
    ...
    console.log(`x: ${x} y: ${y} z: ${z} length: ${view.length}`);
